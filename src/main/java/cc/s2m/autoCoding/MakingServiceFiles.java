...
public class MakingServiceFiles {
    ...
    public static void done(String tableName) throws IOException, TemplateException {
        ...
        Template template = cfg.getTemplate("service.html","utf-8");
        ...
        FileUtils.write(new File(AutoCoding.pathAndName
        		...
        		+ File.separatorChar + "service"
        		+ File.separatorChar + "I" + pojoName + ".java"), 
                out.toString(),"UTF-8", false);
        
        template = cfg.getTemplate("serviceImpl.html","utf-8");
        ...
        FileUtils.write(new File(AutoCoding.pathAndName
        		...
        		+ File.separatorChar + AutoCoding.projectName
        		+ File.separatorChar + "service"
        		+ File.separatorChar + "impl"
        		+ File.separatorChar + pojoName + "Impl.java"), 
                out.toString(),"UTF-8", false);
    }
}
